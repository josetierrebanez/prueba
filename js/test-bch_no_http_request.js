      ...
      app.controller("myCtrl", ['$scope', '$filter', '$http', function ($scope, $filter, $http){
       $scope.names=[
            ...
            {"first_name":"Ruby","last_name":"Flores","email":"rflores2q@altervista.org","fecha_inicio":"14/03/2016","total":"$4726.80"},
            {"first_name":"Lori","last_name":"Reid","email":"lreid2r@prnewswire.com","fecha_inicio":"29/10/2016","total":"$9865.15"}
          ];
